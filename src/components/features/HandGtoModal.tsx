    ...
    <Modal open onClose={onClose} title="GTO 프리플랍 분석" maxWidth="sm" dragToClose>
      {!label ? (
        ...
        <div className="space-y-3 p-4">
          ...
          <p className="text-2xs leading-relaxed text-ink-muted">※ 참고용 근사 레인지(스택·6맥스 오픈 기준)입니다. 멀티웨이·림프·PKO 등 상황 보정은 GTO 탭의 <b className="text-accent-300">스타팅핸드 가이드</b>에서 확인하세요.</p>
        </div>
      )}
    </Modal>
  );
