...
// © 2026 엔에이치홀딩스(NURI HOLDEM). 문항·해설은 자체 작성물(편집 개념 퀴즈 — 솔버 산출 아님).
...
export const SCENARIOS: Scenario[] = [
  ...
  { id: 4, cat: 'turn', spot: 'CO 오픈 → BB 콜. 플랍 체크-체크, 턴 상대 체크', hand: '6♦ 6♣', board: 'K♣ 9♦ 4♠ / 2♥', pot: '팟 5.5bb', options: ['벳', '체크'], answer: '체크', why: '플랍을 체크로 넘긴 K보드에서 66은 쇼다운 가치만 남은 핸드입니다. 벳해 봐야 더 좋은 핸드만 콜하는 역선택. 체크로 저렴하게 쇼다운까지 가는 편이 이론상 우세합니다(쇼다운 밸류 원칙).' },
  ...
  { id: 17, cat: 'cbet', spot: 'SB(나) vs BB 림프 팟. 플랍', hand: 'A♣ 2♣', board: 'A♦ A♥ 6♣', pot: '팟 2bb', options: ['벳', '체크'], answer: '체크', why: '트립스+락 보드. 상대 레인지에 걸리는 게 없어 벳은 전부 접게 만듭니다. 체크로 블러프를 유도하거나 따라오게 하는 슬로플레이가 이론상 우세합니다(너트 우위 트랩).' },
  { id: 18, cat: '3betpot', spot: '3벳 팟. 플랍 시벳에 상대 올인(스택≈팟)', hand: 'Q♦ Q♣', board: 'J♠ 6♦ 3♣', pot: 'SPR ≈ 1', options: ['콜', '폴드'], answer: '콜', why: 'SPR 1 이하의 3벳 팟 오버페어는 폴드하면 명확한 손해입니다. 팟 사이즈 올인의 필요 승률 ~33%를 Jx·드로우·AK 전체 상대로 압도합니다(이 보드·레인지 가정 기준). KK/AA에 일부 지는 건 감수하는 커밋 구간입니다.' },
  ...
  { id: 24, cat: 'cbet', spot: 'UTG 오픈 → BB 콜. 플랍 상대 체크', hand: '6♠ 5♠', board: 'A♦ K♣ 4♥', pot: '팟 5.5bb · 유효 97bb', options: ['벳', '체크'], answer: '벳', why: 'AKx 보드의 AA·KK·AK는 사실상 오픈너에게만 있는 너트 우위. 상대는 강하게 저항할 수 없어 전 레인지 ⅓팟 벳이 이론상 우세합니다. 65s 같은 레인지 최하단도 이 보드에선 벳이 체크보다 나은 것으로 통설이 합의합니다.' },
  ...
  { id: 41, cat: 'sizing', spot: 'BTN 오픈 → BB 콜. 시벳-콜, 턴 체크-체크. 리버 상대 체크. 사이즈는?', hand: 'K♥ T♥', board: 'Q♠ J♦ 4♥ / 8♣ / 9♥', pot: '팟 20bb · 유효 80bb', options: ['⅔팟 벳', '오버벳', '체크'], answer: '오버벳', why: '리버 오버벳은 너트급+블러프로 구성된 폴라 레인지 전용. 너트 스트레이트는 상대의 캡된 원페어에게서 최대치를 뽑아야 합니다. 팟 20bb에 35bb(175%)를 치면 상대 필요 승률이 35/90≈39%로 치솟지만, 콜 레인지의 실제 승률은 0에 가까워 이론상 우세한 사이즈입니다.' },
  ...
  { id: 60, cat: 'river', spot: 'BTN(나) vs BB. 플랍·턴 체크로 흘러온 리버, 상대 체크', hand: '9♦ 9♣', board: 'A♠ Q♣ 5♦ / 7♥ / 2♠', pot: '팟 6bb · 유효 97bb', options: ['벳', '체크'], answer: '체크', why: '99는 상대의 5x·7x·미스드 에어는 이기고 Ax·Qx엔 지는 전형적 쇼다운 밸류 핸드. 벳하면 지는 핸드만 콜합니다(웨이 어헤드/웨이 비하인드). 체크로 공짜 쇼다운을 받는 편이 이론상 우세합니다.' },
