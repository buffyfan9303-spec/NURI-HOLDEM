    ...
    <div className="px-4 pb-6">
      ...
      <Part title="4. 탈퇴 후에도 남는 정보와 보관 기간">
        <List items={[
          ...
          '매장 기록(장부의 참가 기록, 매장이용권 발급·사용 이력, 직원 근무·급여 기록, 손님 관리 기록, 출석 기록, 이미 지난 대회의 예약): 해당 매장이 관리하는 정보로, 보관 기간과 삭제는 매장이 정합니다. 회원 탈퇴만으로는 삭제되지 않으며 해당 매장에 삭제를 요청하실 수 있습니다. 매장이 매장을 영구 삭제하면 함께 파기됩니다.',
