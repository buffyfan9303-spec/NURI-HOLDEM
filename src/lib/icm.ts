...
// 계산은 보드 C(48,5) **전수**(scripts/gen-nash/icm-bench-exact.mjs, 2026-09-25) — 표본오차 0, 소수 첫째 자리 반올림.
// (첫 판은 엔진 몬테카를로 6만회였고 '±0.2%p' 라 적었지만 실제로는 최대 0.5%p 어긋나 있었다 — wide JJ 69.5 → 70.0.)
// 런타임엔 상수 조회만 남아 입력마다 재계산이 없다.
...
const BENCH_EQUITY: Record<ShoveRangeId, readonly number[]> = {
  ...
  tight: [84.3, 65.7, 58.6, 54.1, 55.9, 49.9, 49.5, 46.6, 42.5, 43.5, 39.2, 37.7, 38.2, 37.7],
  mid: [84.5, 71.6, 66.9, 62.2, 61.2, 57.5, 58.2, 54.4, 55.2, 52.3, 48.8, 45.9, 48.4, 43.0],
  wide: [84.6, 73.3, 70.0, 66.7, 63.8, 62.6, 61.4, 59.1, 59.5, 56.4, 52.0, 50.6, 51.9, 46.1],
};
