...
| 게이트 | 명령 | 실측 |
|---|---|---|
| 린트 | `npm run lint` | **2026-09-16 실측 `✖ 301 problems (0 errors, 301 warnings)`** — **error 0 이 게이트**. (2026-09-13 판은 221 이었다. 늘어난 것은 전부 기존 규칙의 파일 증가분이다) |
| 단위 | `npm test` | **2026-09-16 실측 `Test Files 205 passed (205)` · `Tests 2230 passed | 6 skipped (2236)`** (2026-09-13 판 159파일·1866테스트는 두 단계 낡았다) |
